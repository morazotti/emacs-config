...
#+include: "modules/tools/tools-ai-config.el"   src elisp
...
- ~tools-ai-presets-config.el~ :: Defines custom gptel presets (code/physics/proofread/publication/etc.).

#+include: "modules/tools/tools-ai-presets-config.el"   src elisp
