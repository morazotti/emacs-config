...
1.  [Initialization](#org608b6a7)
    1.  [async-init (silent background org export)](#orgb397c8e)
2.  [Core Configuration](#org3f10d5c)
3.  [Org Mode](#orgb756ced)
4.  [AI](#org012fe71)
5.  [Tools](#orgc3c8575)
6.  [Programming Languages](#orgf89d9f6)
...
This config includes `async-init.el`, a small helper that can run some tasks in the background after startup. In particular, it can export Org files **silently** (without popping buffers/windows) so you can, for example, regenerate documentation like `README.md` from `README.org` without interrupting your session.
...
-   **`core-custom-macros-config.el`:** Manages the custom macros to make declarations easier.
